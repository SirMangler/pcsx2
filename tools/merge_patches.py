...
if __name__ == "__main__":
    if len(sys.argv) < 4:
        print(f"Usage: {sys.argv[0]} <ws directory> <ni directory> <60 directory> <dnas directory> <output directory>")
        sys.exit(1)
    ...
    merge_patches(sys.argv[3], outdir, "60 FPS", "Forces the game to run at 60 FPS.")
    merge_patches(sys.argv[4], outdir, "DNAS", "Facilitates online play.")
